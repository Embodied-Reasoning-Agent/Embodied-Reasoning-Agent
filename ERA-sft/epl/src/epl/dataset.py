...
from epl.trainer import rank0_print
...
class LazySupervisedDataset(Dataset):
    ...
    def _get_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources[0]:
            rank0_print("In multimodal mode ...")
            ...
            rank0_print("In text-only mode ...")
            sources = copy.deepcopy([e["conversations"] for e in sources])
            data_dict = self.preprocess_qwen2vl(sources, self.tokenizer, self.processor, [])
        ...
        # rank0_print(f"Sample {i} ID: {data_dict['id']}, data_dict: {data_dict}")
        return data_dict
    ...
    def preprocess_qwen2vl(
        ...
        end_turn_id, t_s, t_e, a_s, a_e = tokenizer.additional_special_tokens_ids[-5:]
        unmask_tokens_idx = [198, im_start, im_end, end_turn_id, t_s, t_e, a_s, a_e]
        ...
        for source in sources:
            ...
            for conv in source:
                ...
                if image_count > 0:
                    ...
                    # print("\nTemplated conversation:", templated_conv)
                        ...
                        conv = [
                            {
                                ...
                                "think_or_action": conv.get("think_or_action", 2),
