...
from epl.constants import agent_system_message, chat_template, grounding_system_message, until, user_instruction, alfred_system_message
...
def generate_response(
    ...
    mode: Literal["self-plan", "force-plan", "grounding", "alfred"] = "alfred",
    temperature: float = 0,
    ...
    if low_level_instruction:
        ...
        recipient_text = "<|im_start|>assistant"
    else:
    ...
    if temperature > 0:
        ...
        cont = model.generate(**inputs, max_new_tokens=max_new_tokens, do_sample=False)
